...
for i in data_dict:
    value_of_interest = data_dict[i]['exercised_stock_options']
    #print (data_dict[i]['exercised_stock_options'])
    if (value_of_interest != 'NaN' ):
        if(value_of_interest < min):
            min = value_of_interest
...
max = 0
for i in data_dict:
    value_of_interest = data_dict[i]['salary']
    #print (data_dict[i]['exercised_stock_options'])
    if (value_of_interest != 'NaN' ):
        if(value_of_interest < min):
            min = value_of_interest
...
labels_l = kmeans.labels_ #not sure why i am saving labels.
pred = labels_l
